...
<!--文件体开始-->
		...
		<form name="order" method="post" action="user/SubmitOrderServlet" >
...
<!--文件尾开始-->
        ...
        <c:forEach items="${shoppingCar.lines}" var="entry">
			<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="ShowBookServlet?id=${entry.key }" target="_blank">${entry.value.book.name }</a></td>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">合计：<font color="#ff0000"><b>￥${shoppingCar.cost }</b></font></td>
		        ...
		        <p align="center">请认真检查以上订单信息，确认无误后，点击 → <a onclick="javascript:document.order.submit();" style="cursor:pointer;"><img src="images/submit.gif"></a>
		        </p>
		</form>
